...
export function renderPortraits(characters) {
  ...
  rail.innerHTML = characters.map(c => {
    const url = `https://ui-avatars.com/api/?name=${encodeURIComponent(c.name)}&background=1a1a2e&color=c9a96e&size=200&bold=true`;
